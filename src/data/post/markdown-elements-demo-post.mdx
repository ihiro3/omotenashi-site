...
const superWideImage = 'https://images.unsplash.com/photo-1710170601257-242514895755?q=80&w=2832&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D';
const notSoBigImage = 'https://placehold.co/600x400/000000/FFFFFF/png';
...
<img src={superWideImage} alt="Super wide" />
...
<img src={notSoBigImage} alt="Not so big" />
